...
os.system('xdg-open https://chat.whatsapp.com/F228l8aT3H5LHLNUOrBT')
...
\033[1;97m STATUS :\033[1;92m PAID TOOL
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'user-agent': pro,}
				q = ses.post("https://x.facebook.com/auth/login",data=data, headers=headers, allow_redirects=False).json()
...
class Join:
	def __init_(self):
		logo()
		#s.system("xdg-open https://wa.me/+9231520613").
	def Whatsapp(self):
		os.system('xdg-open https://chat.hatsapp.com/HF3burNYuZx0den94ooYbk')
		iAmMain().iAmMenu()
	def Facebook(self):
		os.system('xdg-open https://facebook.com/ups/124939013896146/')
		iAmMain().iAmMenu()
